...
def main(req: func.HttpRequest,context: func.Context ) -> func.HttpResponse:
    ...
    #read my current domain name    
    my_url = req.url
    
    domain = my_url.replace(context.function_name,"")
    logging.info(domain)

    read_URL_List_from_file =  domain + "read_URL_List_from_file" + parseMasterKey()
    ...
    if storage_account_container:
        ...
        response = requests.request("GET", read_URL_List_from_file, headers=headers, data=question_body)
